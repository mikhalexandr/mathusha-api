...
def create_default_data():
    ...
    t1 = Topic(name='Сложение',
               ...
               color='#F44336', photo='1.png', placeholder='N')
    t2 = Topic(name='Вычитание', description='Вычитание — одна из вспомогательных бинарных математических операций '
               ...
               color='#E91E63', photo='2.png', placeholder='N')
    t3 = Topic(name='Умножение', description='Умножение — одна из основных математических операций над двумя '
               ...
               color='#9C27B0', photo='3.png', placeholder='N')
    t4 = Topic(name='Деление',
               ...
               color='#673AB7', photo='4.png', placeholder='N')
 ...
 'For exampl                    For example, 25² = 625, √625 = √25 * 25 = 25',
               color='#3F51B5', photo='5.png', placeholder='N')
    t6 = Topic(name='Степень',
               ...
               color='#2196F3', photo='6.png', placeholder='N')
    t7 = Topic(name='Дробь',
               ...
               color='#03A9F4', photo='7.png', placeholder='N.N')
    t8 = Topic(name='Факториал',
               ...
               color='#00BCD4', photo='8.png', placeholder='N')
    t9 = Topic(name='Логарифм',
               ...
               color='#009688', photo='9.png', placeholder='N')
    t10 = Topic(name='Тригонометрические значения',
                ...
                color='#4CAF50', photo='10.png', placeholder='N | √N | √N/M | N/M | ∞')
    t11 = Topic(name='Линейное уравнение',
                ...
                color='#8BC34A', photo='11.png', placeholder='N | N/M')
    t12 = Topic(name='Квадратное уравнение',
                ...
                color='#CDDC39', photo='12.png', placeholder='x1 = N, x2 = M')
    t13 = Topic(name='Линейное неравенство',
                ...
                color='#FFEB3B', photo='13.png', placeholder='N ≤ 6 | N ≥ -9 | N < 6 | N > -9')
    t14 = Topic(name='Смешанная задача',
                ...
                color='#FFC107', photo='14.png', placeholder='ALL TYPES OF ANSWERS ^-^')
    t15 = Topic(name='Yandex GPT',
                ...
                color='#FF9800', photo='15.png', placeholder='N')
